...
The completed V1 manual browser QA findings, prioritized bug handoff, evidence
notes, and follow-up verification baseline were moved to
`docs/bugfix/V1_bugs.md` so this plan can focus on V1.5 development.
